...
// Fork: keep whatsapp bundled into core (single-tarball deploy) instead of
// shipping it as a separate @openclaw/whatsapp plugin. baileys + audio-decode
// are added to root deps so the bundled plugin resolves them at runtime.
