...
const BUSY_MESSAGES = [
  ...
  "Can't chat. I'm defragmenting my thoughts. It's a whole thing.",
  ...
  "Sorry, I'm in the middle of an important task. I'm convincing my code to compile.",
  "Can't right now. I'm busy pretending to be out of office.",
  "I'm touching grass. I'll be back shortly.",
